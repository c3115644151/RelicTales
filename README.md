...
| 目标遗迹 | 注入方块 | 产出主题 | 注入方式 |
|---|---|---|---|
| 丛林神殿 | 可疑的苔石砖 | 自然力量/丛林猎羽符 | Mixin（Legacy 结构） |
| 沙漠神殿 | 可疑的雕纹砂岩 | 太阳文明/太阳神徽章 | Mixin（Legacy 结构） |
| 要塞 | 可疑的裂纹石砖/苔石砖/苔石 | 原版物品 | Mixin（概率替换系统） |
...
│
├── mixin/                       # Mixin 注入
│   ├── MixinStructurePiece.java      # 要塞概率替换
